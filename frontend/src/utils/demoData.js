export const DEMO_USERS = [
  ...
  },
  {
    _id: "demo-user-9",
    name: "Arif Mammadov",
    email: "arif@farmer.az",
    role: "user",
    region: "yevlakh",
    crops: ["Wheat"],
    createdAt: "2026-01-24T11:20:00.000Z",
  },
  {
    _id: "demo-user-10",
    name: "Sofia Rahimova",
    ...
    createdAt: "2026-01-26T08:40:00.000Z",
  },
  {
    _id: "demo-user-11",
    name: "Ogtay Karimov",
    ...
    region: "kurdamir",
    crops: ["Barley"],
    createdAt: "2026-01-28T07:50:00.000Z",
  },
  {
    _id: "demo-user-12",
    name: "Maya Ismayil",
    ...
    region: "imishli",
    crops: ["Cotton"],
    createdAt: "2026-01-30T12:15:00.000Z",
  },
];
...
export const DEMO_DEVICES = [
  ...
  {
    deviceId: "DEV-1006",
    deviceName: "AgroSmart-6",
    ownerId: "demo-user-7",
    ownerName: "Elvin Huseynov",
    ownerEmail: "elvin@farm.az",
    region: "mingachevir",
    location: {
      lat: 40.7694,
      lng: 47.0461,
    ...
    lastActive: new Date().toISOString(),
    firmware: "v1.3.0",
    model: "AgroSmart Plus",
    sensors: { moisture: true, temperature: true, humidity: true },
  },
  {
    deviceId: "DEV-1007",
    deviceName: "AgroSmart-7",
    ownerId: "demo-user-8",
    ownerName: "Nigar Sadiqova",
    ownerEmail: "nigar@agro.az",
    region: "gabala",
    location: { lat: 41.3969, lng: 47.8543, address: "Gabala, Azerbaijan" },
    status: "Offline",
    signalStrength: 22,
  ...
  {
    deviceId: "DEV-1008",
    deviceName: "PumpController-2",
    ownerId: "demo-user-9",
    ownerName: "Arif Mammadov",
    ownerEmail: "arif@farmer.az",
    region: "yevlakh",
    location: { lat: 40.6196, lng: 47.15, address: "Yevlakh, Azerbaijan" },
    status: "Maintenance",
    signalStrength: 48,
  ...
  {
    deviceId: "DEV-1009",
    deviceName: "DripController-2",
    ownerId: "demo-user-10",
    ownerName: "Sofia Rahimova",
    ownerEmail: "sofia@agro.az",
    region: "salyan",
    location: { lat: 39.5753, lng: 48.9847, address: "Salyan, Azerbaijan" },
    status: "Active",
    signalStrength: 75,
    lastActive: new Date().toISOString(),
    firmware: "v1.2.2",
  ...
  {
    deviceId: "DEV-1010",
    deviceName: "BasicIrrig-2",
    ownerId: "demo-user-11",
    ownerName: "Ogtay Karimov",
    ownerEmail: "ogtay@farm.az",
    region: "kurdamir",
    location: { lat: 40.0767, lng: 48.0011, address: "Kurdamir, Azerbaijan" },
    status: "Active",
    signalStrength: 68,
    lastActive: new Date().toISOString(),
    firmware: "v1.0.1",
  ...
  {
    deviceId: "DEV-1011",
    deviceName: "AgroSmart-11",
    ownerId: "demo-user-12",
    ownerName: "Maya Ismayil",
    ownerEmail: "maya@farm.az",
    region: "imishli",
    location: { lat: 39.5233, lng: 48.2428, address: "Imishli, Azerbaijan" },
    status: "Offline",
    signalStrength: 15,
